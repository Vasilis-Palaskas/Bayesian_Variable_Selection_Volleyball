...
ggmcmc(ordered_only_skills_after_bvs_parameters, 
       file = "converg_gg_ordered_only_skills_after_bvs_parameters.pdf", plot=c( "running","traceplot",
                                                                                 "geweke","Rhat","autocorrelation"))

#----Separately across multiple chains
ggmcmc(gg_ordered_only_skills_after_bvs_first_temp_Intercept,
       file = "converg_first_temp_Intercept_ordered_only_skills.pdf", plot=c( "running","traceplot",
                                                               "geweke","Rhat","autocorrelation"))


ggmcmc(gg_ordered_only_skills_after_bvs_beta,
       file = "converg_betas_ordered_only_skills.pdf", plot=c( "running","traceplot",
                                                               "geweke","Rhat","autocorrelation"))

ggmcmc(gg_ordered_only_skills_after_bvs_temp_Intercept,
       file = "converg_intercepts_ordered_only_skills.pdf", plot=c( "running","traceplot",
                                                               "geweke","Rhat","autocorrelation"))
