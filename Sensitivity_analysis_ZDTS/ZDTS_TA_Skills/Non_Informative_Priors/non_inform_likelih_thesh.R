...
data_zdts_skills_std_thres<-list(c_thres=8,c_std=5,
...
full_zdts_skills_8_5<-stan(model_code=sensit_betas_zdts_skills_std_thres.stan,
...
save(full_zdts_skills_10,file="full_zdts_skills_10")
