...
data_zdts_skills_c_1<-list(c=1,n_games=132,
...
data_zdts_skills_c_2<-list(c=2,n_games=132,
                           away_team=as.numeric(data_zdts_skills$away_team),
                           home_team=as.numeric(data_zdts_skills$home_team),
                           n_teams=data_zdts_skills$n_teams,
                           X_home=X_home_std,X_away=X_away_std,K=ncol(X_home_std),
...
data_zdts_skills_c_5<-list(c=5,n_games=132,
                           away_team=as.numeric(data_zdts_skills$away_team),
                           home_team=as.numeric(data_zdts_skills$home_team),
                           n_teams=data_zdts_skills$n_teams,
                           X_home=X_home_std,X_away=X_away_std,K=ncol(X_home_std),
                           hnome_sets=data_zdts_skills$home_sets,
                           away_sets=data_zdts_skills$away_sets)

data_zdts_skills_c_10<-list(c=10,n_games=132,
                            away_team=as.numeric(data_zdts_skills$away_team),
                            home_team=as.numeric(data_zdts_skills$home_team),
                            n_teams=data_zdts_skills$n_teams,
                            X_home=X_home_std,X_away=X_away_std,K=ncol(X_home_std),
...
model {
  ...
  //Priors
  target+=normal_lpdf(beta_home|0,1*c);
  target+=normal_lpdf(beta_away|0,1*c);
...
# c=2
full_zdts_skills_c_2<-stan(model_code=sensit_betas_zdts_TA_skills.stan,data=data_zdts_skills_c_2,thin=1,chains=2,
                                iter=10000,warmup=2000,seed="12345",init_r=1)#15948/16000=99.6% divergent transitions after warmup


# c=5
full_zdts_skills_c_5<-stan(model_code=sensit_betas_zdts_TA_skills.stan,data=data_zdts_skills_c_5,thin=1,chains=2,
                                iter=10000,warmup=2000,seed="12345",init_r=1)#15980/16000=99.8%divergent transitions after warmup

# c=10
full_zdts_skills_c_10<-stan(model_code=sensit_betas_zdts_TA_skills.stan,data=data_zdts_skills_c_10,thin=1,chains=2,
...
save(full_zdts_skills_c_1,file="full_zdts_skills_c_1")
...
# launch_shinystan(full_zdts_skills_c_10)# Not converged
...
beta_home_full_data_zdts_skills_c_2<-extract(full_data_zdts_skills_c_2,pars="beta_home")
beta_away_full_data_zdts_skills_c_2<-extract(full_data_zdts_skills_c_2,pars="beta_away")

beta_home_full_data_zdts_skills_c_5<-extract(full_data_zdts_skills_c_5,pars="beta_home")
beta_away_full_data_zdts_skills_c_5<-extract(full_data_zdts_skills_c_5,pars="beta_away")

beta_home_full_data_zdts_skills_c_10<-extract(full_data_zdts_skills_c_10,pars="beta_home")
beta_away_full_data_zdts_skills_c_10<-extract(full_data_zdts_skills_c_10,pars="beta_away")
...
beta_away_full_data_zdts_skills_c_2<-as.data.frame(beta_away_full_data_zdts_skills_c_2)
beta_home_full_data_zdts_skills_c_5<-as.data.frame(beta_home_full_data_zdts_skills_c_5)
beta_away_full_data_zdts_skills_c_5<-as.data.frame(beta_away_full_data_zdts_skills_c_5)
beta_home_full_data_zdts_skills_c_10<-as.data.frame(beta_home_full_data_zdts_skills_c_10)
beta_away_full_data_zdts_skills_c_10<-as.data.frame(beta_away_full_data_zdts_skills_c_10)

###-----------Rename the coefficients of stan fit objects
colnames(beta_home_full_data_zdts_skills_c_1)<-colnames(beta_home_full_data_zdts_skills_c_2)<-colnames(beta_home_full_data_zdts_skills_c_5)<-
  colnames(beta_home_full_data_zdts_skills_c_10)<-c(
  "(Home) perfect serve","(Home) very good serve","(Home) failed serve","(Home) perfect pass",
  "(Home) very good pass","(Home) poor pass","(Home) failed pass","(Home) perfect att1","(Home) blocked att1",
   "(Home) failed att1","(Home) perfect att2","(Home) blocked att2","(Home) failed att2","(Home) perfect block",
  "(Home) block net violation","(Home) failed block","(Home) failed setting")

colnames(beta_away_full_data_zdts_skills_c_2)<-colnames(beta_away_full_data_zdts_skills_c_5)<-
  colnames(beta_away_full_data_zdts_skills_c_10)<-c(
...
#----c=2
dev_full_zdts_skills_c_2<-extract(full_zdts_skills_c_2,pars="dev_star")
dev_full_zdts_skills_c_2$dev_star

#----c=5

dev_full_zdts_skills_c_5<-extract(full_zdts_skills_c_5,pars="dev_star")
dev_full_zdts_skills_c_5$dev_star


#----c=10

dev_full_zdts_skills_c_10<-extract(full_zdts_skills_c_10,pars="dev_star")
dev_full_zdts_skills_c_10$dev_star


#---- 1)Sensitivity Analysis: Deviances Comparison Table (c=1,2,5,10)
mean(dev_full_zdts_skills_c_1$dev_star)#201.6
sd(dev_full_zdts_skills_c_1$dev_star)#8.9
mean(dev_full_zdts_skills_c_2$dev_star)#203.0
sd(dev_full_zdts_skills_c_2$dev_star)#9.0
mean(dev_full_zdts_skills_c_5$dev_star)#203.7
sd(dev_full_zdts_skills_c_5$dev_star)# 9.3
...
rstan::check_divergences(full_zdts_skills_c_10)#100%



#---- 3) Posterior summary statistics of betas parameters
###---3) Posterior summary statistics of Home coefficients
###---
names(full_zdts_skills_c_1)[c(1:17)]<-names(full_zdts_skills_c_2)[c(1:17)]<-
  names(full_zdts_skills_c_5)[c(1:17)]<-names(full_zdts_skills_c_10)[c(1:17)]<-c(
    "(Home) perfect serve","(Home) very good serve","(Home) failed serve","(Home) perfect pass",
    "(Home) very good pass","(Home) poor pass","(Home) failed pass","(Home) perfect att1","(Home) blocked att1",
    "(Home) failed att1","(Home) perfect att2","(Home) blocked att2","(Home) failed att2","(Home) perfect block",
    "(Home) block net violation","(Home) failed block","(Home) failed setting")

names(full_zdts_skills_c_1)[c(18:34)]<-names(full_zdts_skills_c_2)[c(18:34)]<-
  names(full_zdts_skills_c_5)[c(18:34)]<-names(full_zdts_skills_c_10)[c(18:34)]<-c(
    "(Away) perfect serve","(Away) very good serve","(Away) failed serve","(Away) perfect pass",
    "(Away) very good pass","(Away) poor pass","(Away) failed pass","(Away) perfect att1","(Away) blocked att1",
    "(Away) failed att1","(Away) perfect att2","(Away) blocked att2","(Away) failed att2","(Away) perfect block",
    "(Away) block net violation","(Away) failed block","(Away) failed setting")
...
full_zdts_skills_c_1_summary<-summary(full_zdts_skills_c_1,
...
full_zdts_skills_c_5_summary<-summary(full_zdts_skills_c_5,
                                      pars=c("beta_home","beta_away"))
full_zdts_skills_c_10_summary<-summary(full_zdts_skills_c_10,
                                       pars=c("beta_home","beta_away"))
posterior_summary_betas_zdts_skills<-round(
  cbind(full_zdts_skills_c_1_summary$summary[,c(1,3)],full_zdts_skills_c_2_summary$summary[,c(1,3)],
        full_zdts_skills_c_5_summary$summary[,c(1,3)],full_zdts_skills_c_10_summary$summary[,c(1,3)]),2)
xtable(posterior_summary_betas_zdts_skills)


##---- Convertion to array (necessary for the summaries)
array_posterior_full_data_zdts_skills_c_2<-as.array(full_data_zdts_skills_c_2)
array_posterior_full_data_zdts_skills_c_5<-as.array(full_data_zdts_skills_c_5)
array_posterior_full_data_zdts_skills_c_10<-as.array(full_data_zdts_skills_c_10)
...
plot_beta_home_posterior_full_data_zdts_skills_c_2<-mcmc_areas(beta_home_full_data_zdts_skills_c_2,
...
plot_beta_away_posterior_full_data_zdts_skills_c_2<-mcmc_areas(beta_away_full_data_zdts_skills_c_2,
                                                               prob = 0.95,prob_outer=0.95,
...
plot_beta_home_posterior_full_data_zdts_skills_c_5<-mcmc_areas(beta_home_full_data_zdts_skills_c_5,
                                                               prob = 0.95,prob_outer=0.95,
...
plot_beta_away_posterior_full_data_zdts_skills_c_5<-mcmc_areas(beta_away_full_data_zdts_skills_c_5,
                                                               prob = 0.95,prob_outer=0.95,
...
plot_beta_home_posterior_full_data_zdts_skills_c_10<-mcmc_areas(beta_home_full_data_zdts_skills_c_10,
                                                                prob = 0.95,prob_outer=0.95,
...
plot_beta_away_posterior_full_data_zdts_skills_c_10<-mcmc_areas(beta_away_full_data_zdts_skills_c_10,
                                                                prob = 0.95,prob_outer=0.95,
...
####----Combine the plots
full_data_zdts_skills_c_2_5_areas<-ggarrange(plot_beta_home_posterior_full_data_zdts_skills_c_2, plot_beta_away_posterior_full_data_zdts_skills_c_2,
                                             plot_beta_home_posterior_full_data_zdts_skills_c_5, plot_beta_away_posterior_full_data_zdts_skills_c_5,
                                             ncol = 2, nrow = 2)
full_data_zdts_skills_c_5_10_areas<-ggarrange(plot_beta_home_posterior_full_data_zdts_skills_c_5, plot_beta_away_posterior_full_data_zdts_skills_c_5,
                                              plot_beta_home_posterior_full_data_zdts_skills_c_10, plot_beta_away_posterior_full_data_zdts_skills_c_10,
                                              ncol = 2, nrow = 2)
