...
dev_full_zdts_skills<-extract(full_zdts_only_skills,pars="dev")# Extraction of the model deviance
...
##--Summary Statistics of Model Deviance-divergent transitions
min_dev_vector<-c(min_dev_vector,min(dev_full_zdts_skills$dev))#- Posterior Minimum Deviance
mean_dev_vector<-c(mean_dev_vector,mean(dev_full_zdts_skills$dev))#-Posterior Mean Deviance
sd_dev_vector<-c(sd_dev_vector,sd(dev_full_zdts_skills$dev))#-Posterior Std of Deviance
median_dev_vector<-c(median_dev_vector,median(dev_full_zdts_skills$dev))#-Posterior Median of Deviance
